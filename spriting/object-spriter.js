...
const createObjectSpriteAnimation = (app, {
  ...
  if (!ctx?.usePhysicsTracker || !ctx?.useRenderer) {
    console.warn('missing required ctx physics tracker', {ctx});
    debugger;
  }
  ...
  
  {
    ...
    const physicsTracker = ctx.usePhysicsTracker();
