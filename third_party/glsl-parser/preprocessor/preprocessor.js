...
var expandObjectMacro = function (macros, macroName, macro, text) {
    ...
    var expanded = text;
    if (regex.test(text)) {
        var firstPass = tokenPaste(text.replace(new RegExp("\\b".concat(macroName, "\\b"), 'g'), macro.body));
...
// @ts-ignore
var visitPreprocessedAst = ast_1.visit;
        ...
        conditional: {
            ...
            enter: function (path) {
                ...
                expandInExpressions.apply(void 0, __spreadArray(__spreadArray([macros,
                    ...
                    node.ifPart.expression], node.elseIfParts.map(function (elif) { return elif.expression; }), false), [(_a = node.elsePart) === null || _a === void 0 ? void 0 : _a.body], false));
