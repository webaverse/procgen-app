...
const _handleMethod = async ({method, args, instance: instanceKey, taskId}) => {
  switch (method) {
    ...
    case 'meshoptSimplify': {
      ...
      const result = pg.meshoptSimplify(mesh, targetRatio, targetError);
      return {
        result,
    ...
    case 'meshoptSimplifySloppy': {
      ...
      const result = pg.meshoptSimplifySloppy(mesh, targetRatio, targetError);
      return {
        result,
        transfers: [result.buffer],
      };
